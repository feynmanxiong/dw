...
<template>
	<div>
		...
		<el-container :class="['elContianer',isShowAside?'':'contain_box_in']">
			...
			<!--港口维护主表添加start-->
			<el-dialog title="新建装箱门点" :visible.sync="innerVisible" :append-to-body="true" :modal="true" :before-close="handleDialogClose">
...
　　　　　　　　　pageSize: 10,
				...
				rules: {
					address: [
						{ required: true, message: '请输入装箱门点', trigger: 'blur' },
					],
					status: [
